...
import static net.mortalsilence.dandroid.comm.Commands.BATTERY_LIFE;
import static net.mortalsilence.dandroid.comm.Commands.BOOST;
import static net.mortalsilence.dandroid.comm.Commands.BYPASS;
import static net.mortalsilence.dandroid.comm.Commands.CURRENT_TIME;
import static net.mortalsilence.dandroid.comm.Commands.EXHAUST_TEMPERATURE;
import static net.mortalsilence.dandroid.comm.Commands.EXTRACT_FAN_SPEED;
import static net.mortalsilence.dandroid.comm.Commands.EXTRACT_FAN_STEP;
import static net.mortalsilence.dandroid.comm.Commands.EXTRACT_TEMPERATURE;
import static net.mortalsilence.dandroid.comm.Commands.FILTER_LIFE;
import static net.mortalsilence.dandroid.comm.Commands.FILTER_PERIOD;
import static net.mortalsilence.dandroid.comm.Commands.HUMIDITY;
import static net.mortalsilence.dandroid.comm.Commands.MANUAL_FAN_SPEED_STEP;
import static net.mortalsilence.dandroid.comm.Commands.MODE;
import static net.mortalsilence.dandroid.comm.Commands.NIGHT_COOLING;
import static net.mortalsilence.dandroid.comm.Commands.OUTDOOR_TEMPERATURE;
import static net.mortalsilence.dandroid.comm.Commands.REGISTER_0_READ;
import static net.mortalsilence.dandroid.comm.Commands.REGISTER_1_READ;
import static net.mortalsilence.dandroid.comm.Commands.REGISTER_1_WRITE;
import static net.mortalsilence.dandroid.comm.Commands.REGISTER_4_READ;
import static net.mortalsilence.dandroid.comm.Commands.ROOM_TEMPERATURE;
import static net.mortalsilence.dandroid.comm.Commands.ROOM_TEMPERATURE_CALCULATED;
import static net.mortalsilence.dandroid.comm.Commands.SUPPLY_FAN_SPEED;
import static net.mortalsilence.dandroid.comm.Commands.SUPPLY_FAN_STEP;
import static net.mortalsilence.dandroid.comm.Commands.SUPPLY_TEMPERATURE;
import static net.mortalsilence.dandroid.comm.Commands.UNIT_NAME;
import static net.mortalsilence.dandroid.comm.Commands.UNIT_SERIAL;
